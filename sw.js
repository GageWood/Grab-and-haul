const CACHE="grab-haul-v23";
const ASSETS=["./","./index.html","./app.css","./app.js?v=20260924-5","./photo-estimate-ui.js","./manifest.json","./grab-and-haul-logo.svg","./icon.svg","./icon-192.svg","./icon-512.svg"];
